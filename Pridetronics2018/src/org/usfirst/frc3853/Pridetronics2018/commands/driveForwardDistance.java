...
public class driveForwardDistance extends Command {
  ...
  protected void initialize() {
    ...
    Encoder leftDriveEncoder = Robot.drive.getLeftEncoder();
    Encoder rightDriveEncoder = Robot.drive.getRightEncoder();

    SmartDashboard.putNumber("LeftEncoder", leftDriveEncoder.getDistance());
    SmartDashboard.putNumber("RightEncoder", rightDriveEncoder.getDistance());
